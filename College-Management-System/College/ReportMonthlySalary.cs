...
namespace College
{
    public partial class ReportMonthlySalary : Form
    {
        public ReportMonthlySalary()
        {
            InitializeComponent();
        }
        ...
        private void ReportDailyExpenditure_Load(object sender, EventArgs e)
        {
            ...
            if (Common.command == true)
            {
                try
                {
                    ...
                    this.monthlySalaryTableAdapter.Fill(this.collegeDataSet.MonthlySalary, Common.month, Common.year);
