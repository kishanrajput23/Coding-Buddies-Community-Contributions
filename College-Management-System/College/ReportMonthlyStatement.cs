...
namespace College
{
    public partial class ReportMonthlyStatement : Form
    {
        public ReportMonthlyStatement()
        {
            InitializeComponent();
        }
        ...
        private void ReportDailyExpenditure_Load(object sender, EventArgs e)
        {
            ...
            if (Common.command == true)
            {
                try
                {
                    ...
                    this.monthlyStatementTableAdapter.Fill(this.collegeDataSet.MonthlyStatement, Common.month, Common.year.ToString());
