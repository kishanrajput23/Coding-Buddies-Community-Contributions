namespace College
{
    partial class ReportMonthlySalary
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.monthlySalaryTableAdapter = new College.App_Data.CollegeDataSetTableAdapters.MonthlySalaryTableAdapter();
            ...
            this.label2.Text = "REPORT MONTHLY SALARY";
            // 
            // panel2
            // 
            ...
            reportDataSource1.Value = this.monthlySalaryBindingSource;
            reportDataSource2.Name = "DataSet2";
            reportDataSource2.Value = this.settingsBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "College.Reports.MonthlySalary.rdlc";
            ...
            // 
            this.monthlySalaryBindingSource.DataMember = "MonthlySalary";
            this.monthlySalaryBindingSource.DataSource = this.collegeDataSet;
            // 
            // monthlySalaryTableAdapter
            // 
            this.monthlySalaryTableAdapter.ClearBeforeFill = true;
            // 
        ...
        private App_Data.CollegeDataSetTableAdapters.MonthlySalaryTableAdapter monthlySalaryTableAdapter;
